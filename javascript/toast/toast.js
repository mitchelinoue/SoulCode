...
//<script src="js/estadoDaConexão.js"></script>
...
divToastContainer.classList.add('toast-container', 'position-fixed', 'bottom-0', 'end-0', 'p-3');
...
// divLiveToast.dataBsAutohide = "false";
